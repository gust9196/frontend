...
function SearchCustomerComponent({ goToNextStep, onSelectCustomer }) {
  ...
  const handleNewCustomerClick = () => {
    navigate('/new-customer'); // Skifter til "RegisterNewCustomer" rute
  };
          ...
          <div className="cc-div-6">
            <div className="cc-column">
              <div className="cc-div-7">
                ...
                <input className='search-customer-input' type="text" value={searchTerm} onChange={handleChange} placeholder="Søg kunde..." />
                <div>
            ...
            <div className="cc-column-2">
              <div className="cc-div-10">
                ...
                <div onClick={handleNewCustomerClick} className="cc-div-12">Opret kunde</div>
              </div>
            </div>
          </div>
        </div>
