    ...
    <>
      <div className="sb-main-container" style={{ top: `${sidebarTop}px` }}>
        ...
        <button
          ...
          onClick={() => handleButtonClick("/new-agreement")}
        >
          Register ny aftale
        </button>
        <button
        ...
        <button
          className="sb-description"
          onClick={() => handleButtonClick("/new-customer")}
        >
          Register ny kunde
        </button>
        <button
          className="sb-description"
          onClick={() => handleButtonClick("/leaseagreementlist")}
        >
          Nuværende aftaler
        </button>
        <button
          className="sb-description"
          onClick={() => handleButtonClick("/damage-repair")}
        >
          Skade og udbedring
        </button>
        <button
        ...
        <button
          className="sb-description"
          onClick={() => handleButtonClick("/customerslist")}
        >
          Kunder
        </button>
        <button
