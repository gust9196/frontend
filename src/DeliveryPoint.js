...
function DeliveryPoint({ goToNextStep, onSelectDeliveryPoint }) {
  ...
  const updateLocation = (locationArray, value, setLocation) => {
    const selectedLocation = locationArray.find(loc => loc.id.toString() === value);
            ...
            <div className="cc-div-6">
              <div className="cc-column">
                <div className="cc-div-7">
                  ...
                  <select value={pickupLocation.id || ''} onChange={(e) => updateLocation(pickupLocations, e.target.value, setPickupLocation)}>
              ...
              <div className="cc-column-2">
                <div className="cc-div-10">
                  ...
                  <select value={dropoffLocation.id || ''} onChange={(e) => updateLocation(dropoffLocations, e.target.value, setDropoffLocation)}>
