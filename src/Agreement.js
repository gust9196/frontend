              ...
              <div className="cc-column">
                <div className="cc-div-7">
                  ...
                  <div className="agreement-container">
                    ...
                    <div><strong>Afhentningssted:</strong> {deliveryPointData && deliveryPointData.pickupLocation.address}</div>
                    <div><strong>Afleveringssted:</strong> {deliveryPointData && deliveryPointData.dropoffLocation.address}</div>
