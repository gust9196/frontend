            ...
            <form onSubmit={handleSubmit}>
                ...
                <div className='row-container'>
                    <div className='row-1'>
                        <div className="div-title">Bilmærke</div>
                          <select name="carBrand" className="custom-select" value={carData.carBrand} onChange={handleChange}>
                ...
                Register ny bil
                    ...
                    <div className='row-2'>
                        ...
                        <input type="text" name="dateOfPurchase" className="div-input" value={carData.dateOfPurchase} onChange={handleChange} />
                        <div className="div-title">Link til billede</div>
                        <input type="text" name="urlPhoto" className="div-input" value={carData.urlPhoto} onChange={handleChange} />
                    </div>
                </div>
                </form>
            </div>
