      ...
      <div className="sb-main-container">
        <div className="sb-image-wrapper">
          <img className="sb-logo"
            loading="lazy"
            srcSet="https://cdn.builder.io/api/v1/image/assets/TEMP/24c44ed3-454d-4064-b434-2edf48aab9e2?apiKey=5aea209633a743968e186ed24c6841a0&width=100 100w, https://cdn.builder.io/api/v1/image/assets/TEMP/24c44ed3-454d-4064-b434-2edf48aab9e2?apiKey=5aea209633a743968e186ed24c6841a0&width=200 200w, https://cdn.builder.io/api/v1/image/assets/TEMP/24c44ed3-454d-4064-b434-2edf48aab9e2?apiKey=5aea209633a743968e186ed24c6841a0&width=400 400w, https://cdn.builder.io/api/v1/image/assets/TEMP/24c44ed3-454d-4064-b434-2edf48aab9e2?apiKey=5aea209633a743968e186ed24c6841a0&width=800 800w, https://cdn.builder.io/api/v1/image/assets/TEMP/24c44ed3-454d-4064-b434-2edf48aab9e2?apiKey=5aea209633a743968e186ed24c6841a0&width=1200 1200w, https://cdn.builder.io/api/v1/image/assets/TEMP/24c44ed3-454d-4064-b434-2edf48aab9e2?apiKey=5aea209633a743968e186ed24c6841a0&width=1600 1600w, https://cdn.builder.io/api/v1/image/assets/TEMP/24c44ed3-454d-4064-b434-2edf48aab9e2?apiKey=5aea209633a743968e186ed24c6841a0&width=2000 2000w, https://cdn.builder.io/api/v1/image/assets/TEMP/24c44ed3-454d-4064-b434-2edf48aab9e2?apiKey=5aea209633a743968e186ed24c6841a0&"className="img"
          />
          <button className="sb-description" onClick={() => handleButtonClick('/register')}>
            Register ny aftale
          </button>
          ...
          <button className="sb-description" onClick={() => handleButtonClick('/customers')}>
            Kunder
          </button>
